...
open class GalleryViewController: UIPageViewController, ItemControllerDelegate {
    ...
    //CHANGE: Made removePage public
    public func removePage(atIndex index: Int) {
    ...
    //CHANGE: Made closeGallery public 
    public func closeGallery(_ animated: Bool, completion: (() -> Void)?) {
...
//        }
    ...
    open var photoSingleTap:        (() -> Void)?
    public func itemControllerDidSingleTap(_ controller: ItemController) {
        if photoSingleTap != nil{photoSingleTap!()}
        self.decorationViewsHidden.flip()
        if self.decorationViewsHidden == true{
            self.overlayView.overlayColor = UIColor.black
            showStatusBar = true
        }
        else{
            self.overlayView.overlayColor = UIColor.white
            showStatusBar = false
        }
